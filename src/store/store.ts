...
export class Store {
	...
	private readonly incomingchatHandler;
	...
	constructor(sessionId: string, event: BaileysEventEmitter) {
		...
		this.incomingchatHandler = handlers.incomingchatHandler(sessionId, event);
		this.listen();
	}
	...
	public listen() {
		...
		this.incomingchatHandler.listen();
	}
	...
	public unlisten() {
		...
		this.incomingchatHandler.unlisten();
	}
}
